...
class Sample():
    ...
    def process_data(self, data):
        ...
        if not 'step' in self.control_file.columns:
            self.control_file['step'] = self.control_file.index       
